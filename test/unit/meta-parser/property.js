...
const Property = require('../../../lib/meta-parser').Property;
...
describe('Property', () => {
    describe('constructor', () => {
        it('should throw if key is not defined', () => {
            ...
            expect(() => new Property(key)).to.throw(/Key/);
        });
    ...
    describe('parse', () => {
        ...
        it('should return default value if value to parse and default value are undefined', () => {
            const parser = new Property('foo', {
                defaultValue: 'bar'
            });
