...
module.exports = class Document {
    ...
    get isChanged() {
        return this.meta
            ? this.hash !== this.meta.userMetaHash
            : false;
    }
    ...
    /**
     * Updates own hash with and forces meta update to be written on disc.
     * Updates own meta with `{hash: this.hash}` and makes subsequent `meta.write` call
     */
    updateHash() {
