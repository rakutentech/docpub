...
module.exports = class Document {
     ...
     * @param {Document} [parent] - optional parent Document for this Document
     *
     * @throws {Error} Will throw error if path is not string or empty
     */
    constructor(docPath, config, parent) {
        ...
        if (!config) {
            throw new Error('No config provided for Document instance');
        }
     ...
     */
    updateHash() {
        logger.trace(`Updating hash for document ${this.path}\n New hash: ${this.hash}`);
