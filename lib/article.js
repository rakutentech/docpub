...
const SupportedStaticTypes = ['.jpg', '.jpeg', '.png', '.pdf'];

/**
 * A class representing ZenDesk article.
 * Responsible for reading article contents (.md and resources in .jpg, .jpeg, .png and .pdf)
