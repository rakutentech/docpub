...
module.exports = class Article extends Document {
     ...
     * Before converting markdown reads the contents of previously found markdown file, implementing lazy load pattern
    ...
    convertMarkdown() {
        ...
        return fs.readFile(this._markdownPath)
            .then(markdown => this._mdRenderer.render(markdown))
            .then(html => {
                this._html = html;
